                ...
                <div class="p-6 text-gray-900">
                    <form action="{{route('articles.store')}}" method="post">
                        ...
                        <div>
                            ...
                            <div class="mt-3 mb-2">
                                <input value="{{old('title')}}" type="text" name="title" placeholder="Enter Title" class="border-gray-300 shadow-sm w-1/2 rounded-lg">
                                @error('title')
                            ...
                            <div class="mt-3 mb-2">
                                <textarea name="text" id="" cols="30" rows="10" placeholder="Enter Content" class="border-gray-300 shadow-sm w-1/2 rounded-lg">{{old('text')}}</textarea>
                            </div>

                            <label for="" class="text-lg font-medium">Author</label>
                            <div class="mt-3 mb-2">
                                <input value="{{old('author')}}" type="text" name="author" placeholder="Author" class="border-gray-300 shadow-sm w-1/2 rounded-lg">
                                @error('author')
                                <p class="text-red-400 font-medium mb-2">{{$message}}</p>
                                @enderror
                            </div>
